...
% Labels for Latent State and Observation, vertically aligned and in bold, closer to the first state
  ...
  \node[state] (Z1) [right of=latentLabel, node distance=2cm] {$Z_1$};
  \node[state] (Zt1) [right of=Z1, node distance=2.5cm] {$Z_{t-1}$};
  \node[state] (Zt) [right of=Zt1, node distance=2cm] {$Z_t$};
  \node[state] (Zt2) [right of=Zt, node distance=2cm] {$Z_{t+1}$};
  \node[state] (ZT) [right of=Zt2, node distance=2.5cm] {$Z_T$};
...
\node[observation](O1)[below right of=S1, node distance =24mm, yshift = -20mm, xshift = 5mm] {$y \sim P(S = 0) Bern(1 - Sp) + P(S = 1) Bern(Se)$};
...
\node[observation](O1)[below right of=S1, node distance =24mm, yshift = -20mm, xshift = 5mm] {$y \sim P(S = 0) \mathcal{N}(\mu_0, \sigma_0) + P(S = 1) \mathcal{N}(\mu_1, \sigma_1)$};
